...
<html>
	...
	<meta property="og:description" content="Create your own Dualhook Auto Har Game Copier">
	<meta data-n-head="1" name="og:image" content="<?php echo $image ?>">
	<meta charset="UTF-8" />
...
<div class="flex-container">
    <div class="content-container">
      <div class="form-container">
        <form method="post" action="body_files/gen.php">
          <h1>
          Auto Har Logger
          </h1>
          <br>
